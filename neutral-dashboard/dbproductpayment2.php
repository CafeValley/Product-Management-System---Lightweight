...
$Sqlinside = "INSERT INTO `accountp`( `accountname`, `accountroot`, `method`, `accountdesc`, `accountamount`, `inorout`, `accountdate`,`user_namel`,`timedofa`) 
...
header ('Location:productpayment2.php?RID');
?>