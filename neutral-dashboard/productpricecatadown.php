...
include 'header.php';
$main3 = "true";
$active16 = 'bg-blue-600 text-white';
include 'menu.php';
...
<div class="min-h-screen bg-gray-100 p-4">
  <div class="max-w-6xl mx-auto">
    <header class="mb-6">
      <h1 class="text-2xl font-semibold text-gray-800">صفحة تغير الاسعار      <small class="text-sm text-gray-500"> نقص سعر صنف بالنسبة المئوية   </small></h1>
    </header>
    ...
    <div class="bg-white shadow rounded-lg p-6">
      ...
      <form class="max-w-xl mx-auto" action="dbproductpricecatadown.php" method="POST">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center">
          <label for="newboughtprice" class="md:w-1/3 text-right font-semibold mb-2 md:mb-0">نسية النقص</label>
          <div class="md:flex-1">
            <input
              type="text"
              name="newboughtprice"
